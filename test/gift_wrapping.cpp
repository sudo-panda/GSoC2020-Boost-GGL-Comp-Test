...
BOOST_AUTO_TEST_CASE( test_on_left )
{
    typedef bg::model::d2::point_xy<double> point_t;
    BOOST_CHECK_EQUAL(gift_wrapping::detail::on_left::apply(
            bg::make<point_t>(1,1),
            bg::make<point_t>(0,0),
            bg::make<point_t>(0,1)
        ), false);
    BOOST_CHECK(gift_wrapping::detail::on_left::apply(
            bg::make<point_t>(1,1),
            bg::make<point_t>(0,1),
            bg::make<point_t>(0,0)
        ));
...
BOOST_AUTO_TEST_CASE( test_is_collinear )
{
    typedef bg::model::d2::point_xy<double> point_t;
    BOOST_CHECK( ! gift_wrapping::detail::is_collinear::apply(
            bg::make<point_t>(1,1),
            bg::make<point_t>(0,0),
            bg::make<point_t>(0,1)
        ));
...
BOOST_AUTO_TEST_CASE( test_is_farther )
{
    typedef bg::model::d2::point_xy<double> point_t;
    BOOST_CHECK( ! gift_wrapping::detail::is_farther::apply(
            bg::make<point_t>(1,1),
            bg::make<point_t>(0,0),
            bg::make<point_t>(0,1)
        ));
